...
anychart.onDocumentReady(function () {
    var data = [
        {x: "계양산", value: 80, category: "관광"},
        {x: "소래포구", value: 56, category: "관광"},
    ...
    chart.textSpacing(2); // set text spacing
    ...
    chart.container("word_cloud_3");  // set the container id, 차트를 그릴 HTML 요소의 ID를 지정합니다.
