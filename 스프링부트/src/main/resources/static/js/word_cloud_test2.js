...
anychart.onDocumentReady(function () {
    ...
    console.log("category2 타입: " + typeof category2);

    if(typeof category2 ==="object"){
        console.log("객체임")
        console.log("값은이거임"+category2);

        var keyword = category2.spilt(',');
        console.log(keyword);
    }else {
        console.log("아니라고");
    }
        //
        // var keyword = category2.keyword;
        // console.log("넌 어디있니?"+category2.keyword);
        // var keywordData = [];
        ...
        var data = [
            keywordData.push({x: keywordData[0].x, value: keywordData[0].x, link: keywordData[0].x}),
