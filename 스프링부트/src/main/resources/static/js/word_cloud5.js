...
var cloudX4 = cloudTitle4;
var cloudValue4 = cloudValues4;
console.log("x값"+cloudX4);
console.log("밸류값"+cloudValue4);
...
anychart.onDocumentReady(function () {
    ...
    chart.container("word_cloud5");  // set the container id, 차트를 그릴 HTML 요소의 ID를 지정합니다.
